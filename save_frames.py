...
def save_frames(video_path, crop=False, start_frame=None, end_frame=None, skip_frames_save=None):
    ...
    print(f"Total de imagens salvas: {saved_count}")

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Save frames from video based on ranges.")
